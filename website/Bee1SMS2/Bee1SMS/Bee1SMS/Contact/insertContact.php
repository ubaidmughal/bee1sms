...
if(isset($_POST["operationContact"]))
{
    ...
    if($_POST["operationContact"] == "getcountries")
	{
        $output = array();
        ...
        {
            $output["countryname"] = $row["countryname"];
        }
        echo json_encode($output);
    }

    if($_POST["operationContact"] == "getstates")
	{
        $output = array();
        $statement = $connection->prepare(
        ...
        foreach($result as $row)
        {
            $output["statename"] = $row["statename"];
        }
        echo json_encode($output);
    }

    if($_POST["operationContact"] == "getcities")
	{
        $output = array();
        $statement = $connection->prepare(
