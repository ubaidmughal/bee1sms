...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="update" id="'.$row["ContactId"].'" class="btn btn-warning btn-xs update"><i class="fa fa-pencil"></i></button>&nbsp<button type="button" name="delete" id="'.$row["ContactId"].'" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i></button>';
	//$sub_array[] = ;
	$data[] = $sub_array;
}
$output = array(
