        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <p class="centered"><a href=""><img src="/assets/img/Orange-bee.png" width="150"></a></p>
                    ...
                    <li class="mt">
                     ...
                     <a class="active" href="/Feeheader.php">
