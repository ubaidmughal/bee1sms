    ...
    <body>
      ...
      <!--insert New Group-->
            ...
            <div  class="panel-body none formData" id="editForm">
                ...
                <form  class="form" id="userForm">
                    <div  class="col-sm-6 col-xs-12">
                        ...
                        <div  class="form-group">
                        <label> Activity Description</label>
                        <input type="text"  class="form-control" name="ActivityDescription" id="ActivityDescriptionEdit" required />
                    </div>
                    </div>
	    ...
	    <div  class="panel-body">
                  ...
                  <table class="table table-striped display table-responsive table-bordered example">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Activity Name</th>
