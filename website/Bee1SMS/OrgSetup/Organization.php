        ...
        <div class="panel panel-default users-content">
            ...
            <div class="panel-body none formData" id="addForm">
                ...
                <form class="form" id="userForm">
                    ...
                    <a href="javascript:void(0);" class="btn btn-success" onclick="Orgaction('add')">Add User</a>
                    </div>
                    </div>
            ...
            <div class="panel-body none formData" id="editForm">
                ...
                <form class="form" id="userForm">
                    ...
                    <a href="javascript:void(0);" class="btn btn-success" onclick="Orgaction('edit')">Update Organization</a>
                        </div>
                    </div>
